...
export interface ListMarketRequest extends PageRequest { categoryId?: null | string; keyword?: null | string; locale: Locale; mode: MarketListMode; sortBy: string; sortOrder: 'asc' | 'desc' }
