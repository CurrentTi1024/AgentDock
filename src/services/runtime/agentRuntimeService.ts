...
import { serviceMode } from '@/services/core/serviceMode';
...
export const agentRuntimeService: AgentRuntimeService = serviceMode === 'http' ? new CopilotHeadlessHttpService() : new CopilotHeadlessMockService();
