...
export const marketItemsMockData: {
  ...
  skill: [
    { id: 'document-summary', name: '文档摘要', icon: '📄', description: '提取文档重点并生成结构化摘要。', ownerId: 'knowledge', ownerName: 'Knowledge Team', ownerType: 'Organization', category: '文档', isValidated: true, metric: '326 次安装', createTimeAt: '2026-07-01T09:00:00+08:00', updatedAt: '2026-08-14T16:00:00+08:00', versions: [version('F15B', '1.0.0')] },
    { id: 'secure-review', name: '安全代码审查', icon: '🛡️', description: '识别代码缺陷、依赖风险和常见安全问题。', ownerId: 'security', ownerName: 'Security Team', ownerType: 'Organization', category: '开发', isValidated: true, metric: '291 次安装', createTimeAt: '2026-06-08T09:00:00+08:00', updatedAt: '2026-08-12T11:00:00+08:00', versions: [version('F15B', '1.1.0'), version('F18B', '1.0.4')] },
  ],
  mcp: [
    { id: 'company-git', name: 'Company Git MCP', icon: '🔧', description: '读取公司 Git 仓库、提交和 Pull Request。', ownerId: 'dev-platform', ownerName: 'Developer Platform', ownerType: 'Organization', category: '开发工具', isValidated: true, metric: '850 次安装', createTimeAt: '2026-05-10T09:00:00+08:00', updatedAt: '2026-08-16T11:00:00+08:00', versions: [version('F15B', '2.0.0'), version('F18B', '1.8.0', false)] },
    { id: 'flight-data', name: 'Flight Data MCP', icon: '📡', description: '按权限读取飞行试验遥测和指标数据。', ownerId: 'flight-platform', ownerName: 'Flight Platform', ownerType: 'Organization', category: '数据', isValidated: true, metric: '208 次安装', createTimeAt: '2026-06-11T09:00:00+08:00', updatedAt: '2026-08-11T10:00:00+08:00', versions: [version('F15B', '1.2.0')] },
  ],
};
