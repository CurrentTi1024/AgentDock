...
| M2 对话页 | 已完成 | ChatHeader/ChatItem/ChatInput/MessageBlocks/Welcome，接 runStore 与 IndexedDB |
...
- [x] 需求 Review / Code Review 已输出详细设计与缺口清单：见 `docs/agentdock/design/`（00 索引、01 端到端链路、02 AG-UI、03 A2UI、04 Registry、05 渲染矩阵、06 CopilotKit 接入、07 联调调试指南）。
