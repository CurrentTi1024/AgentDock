...
- assistant `TEXT_MESSAGE_*` 中显式 fenced `html/htm/svg/mermaid/markdown/md` 代码块映射到右侧工作面板；
  HTML/SVG/Mermaid/Markdown renderer 按 LobeHub 本地源码分发，不定义后端 Artifact Activity。
